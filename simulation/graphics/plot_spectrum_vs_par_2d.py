'''
Plots the dependence of the simulated spectra on the parameter 'par'
'''
...
def plot_spectrum_vs_par_2d(xs, par, ys, xnormalized=False, xn=[], save_figure=False, filename='', par_label='', invert_paxis=False):
    ...
    if xnormalized:
        for i in range(Npar):
            ...
            #plt.text(np.amax(xn) + 0.5, baseline[0] - 0.07, str(par[i]))
