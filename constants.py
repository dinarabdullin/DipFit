...
const['theta'] = np.linspace(0.0, 90.0, 91)
const['xi'] = np.linspace(0.0, 90.0, 361)
const['phi'] = np.linspace(0.0, 180.0, 91)
const['E'] = np.linspace(0.0, 0.33, 101)
const['variableNames'] = ['r_mean',
						  'r_width', 
						  'xi_mean', 
						  'xi_width', 
						  'phi_mean', 
						  'phi_width', 
						  'temp']
const['longVariableNames'] = ['r mean (nm)',
							  'r width (nm)', 
							  'xi mean (deg)', 
							  'xi width (deg)', 
							  'phi mean (deg)', 
							  'phi width (deg)', 
							  'temperature (K)']
const['variableScales'] = {'r_mean'   : 1.0,
						   'r_width'  : 1.0, 
						   ...
						   'temp'     : 1.0}
const['variableLabels'] = {'r_mean'   : r'$\langle\mathit{r}\rangle$ (nm)',
